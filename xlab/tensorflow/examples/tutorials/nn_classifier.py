...
# Data sets
IRIS_DATA_PATH = oneliners.DATA_PATH+"/iris_data/"

IRIS_TRAINING = IRIS_DATA_PATH+"iris_training.csv"
IRIS_TRAINING_URL = "http://download.tensorflow.org/data/iris_training.csv"

IRIS_TEST = IRIS_DATA_PATH+"iris_test.csv"
...
def main():
    ...
    classifier = tf.contrib.learn.DNNClassifier(feature_columns=feature_columns, 
                                                ...
                                                n_classes=3,
                                                model_dir=oneliners.TEST_RESULTS_PATH+"/iris_model3/")
